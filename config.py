...
class MlflowConfig:
    ...
    s3_endpoint_url = environ.var(help="The S3 endpoint URL that MLFlow Server will store artifacts")
    s3_bucket = environ.var("mlflow", help="The bucket in the S3 instance used by MLFlow Server to store artifacts")
    access_key = environ.var(name="AWS_ACCESS_KEY_ID", help="The Access Key for the S3 instance")
    secret_key = environ.var(name="AWS_SECRET_KEY_ID", help="The Secret Key for the S3 instance")
